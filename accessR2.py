...
# from driver import REMOTE_DIR, UPLOAD_DIR
REMOTE_DIR = "recordings/loQnPl/3/ZTERzsbq7K6P8302x5VFNVMAf0CvpCLm"
# UPLOAD_DIR = "recordings/loQnPl12345/3/ZTERzsbq7K6P8302x5VFNVMAf0CvpCLmuser_00"
# LOCAL_DIR = "/home/dampdigits/Videos/merged_vids/"
...
# Download chunks
response = s3.list_objects_v2(Bucket=BUCKET_NAME, Prefix=REMOTE_DIR)
print(response)
